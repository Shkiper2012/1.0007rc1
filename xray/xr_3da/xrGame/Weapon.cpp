...
#include "../../../build_config_defines.h" // for: AMMO_FROM_BELT, ONE_CLICK_ZOOM
...
bool CWeapon::Action(s32 cmd, u32 flags)
{
	...
	case kWPN_ZOOM_INC:
	case kWPN_ZOOM_DEC:
		if (IsZoomEnabled() && IsZoomed() && m_bScopeDynamicZoom && IsScopeAttached() && (flags&CMD_START))  // fixed by Sin! // Corrected zooming in/out command handler //
		{

...
bool __declspec(dllexport) force_flush_log = true;	// alpet: выставить в true если лог все-же записываетс€ плохо при вылете. —лишком часта€ запись лога вредит SSD и снижает произволительность.

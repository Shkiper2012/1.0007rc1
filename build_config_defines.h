...
// Shkiper2012: Если начал перезаряжаться и сразу побежал, то это правка LOCK_RELOAD_IN_SPRINT не сработает!
...
#define HIDE_WEAPON_IN_INV 				// Спрячем/показываем предмет в руках, когда откр./закр. инвентарь. 
